...
/// <summary>
/// Represents a Shadow Bolt ability action in combat.
...
/// </summary>
public class ShadowBoltAction : ICombatAction
{
    ...
    public ShadowBoltAction(Unit source, Unit target, int amount, int targetHPBefore, int targetHPAfter, int targetMaxHP, Sprite sprite = null)
    {
    ...
    {
        Log.Info("ShadowBoltAction.Play", new
        {
        ...
        // Show shadow damage UI
        ctx.UI.ShowDamage(Target, Amount, TargetHPBefore, TargetHPAfter, TargetMaxHP, DamageType.Shadow);
