...
namespace Core.StatusEffects
{
    ...
    ///     Assign a BleedData asset wherever a Bleed effect needs to be created
    ///     (e.g. BleedUpgrade passive, BloodRitual artifact) so values can be
    ///     tuned in the Unity Inspector without touching runtime code.
    /// </summary>
    [CreateAssetMenu(menuName = "Status Effects/Bleed Data")]
    public class BleedData : ScriptableObject
    {
